...
const projects = [
  {
    title: "Manoj Tours",
    description:
      "A fullstack tours and travels web application to manage data and track customers.",
  ...
  },
  {
    title: "Quco",
    description:
      "An frontend-application inventory-based application for an ecommerce fashion selling business.",
    techStack: [
      <img src={reactLogo} alt="react-logo" key={1} />,
  ...
  },
  {
    ...
    description:
      "A personal developer diary web app to track progress, document DSA solutions, share blogs, and showcase projects in one place.",
    type: "Personal Project",
    techStack: [
      <img src={reactLogo} alt="react-logo" key={1} />,
      <img src={typecriptLogo} alt="typescript-logo" key={2} />,
      <img src={tailwindlogo} alt="tailwind" key={3} />,
      <img src={nodejsLogo} alt="nodejs-logo" key={4} />,
